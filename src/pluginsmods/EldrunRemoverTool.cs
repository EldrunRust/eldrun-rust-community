...
{
    [Info("EldrunRemoverTool", "Eldrun", "36187")]
    [Description("Building and entity removal tool")]
    public class EldrunRemoverTool : RustPlugin
    {
        #region Fields
        ...
        private const string PERMISSION_ALL = "eldrunremovertool.all";
        private const string PERMISSION_ADMIN = "eldrunremovertool.admin";
        private const string PERMISSION_NORMAL = "eldrunremovertool.normal";
        private const string PERMISSION_TARGET = "eldrunremovertool.target";
        private const string PERMISSION_EXTERNAL = "eldrunremovertool.external";
        private const string PERMISSION_OVERRIDE = "eldrunremovertool.override";
        private const string PERMISSION_STRUCTURE = "eldrunremovertool.structure";
        ...
        private static EldrunRemoverTool _instance;
