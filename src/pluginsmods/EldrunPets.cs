...
{
    [Info("EldrunPets", "Eldrun", "36187"), Description("Gives players the ability to tame and have pets")]
    class EldrunPets : RustPlugin
    {
        #region Fields        
        private static EldrunPets ins;
        private BUTTON Main;
        ...
        private void RegisterPermissions()
        {
            ...
            foreach (var name in names)
                permission.RegisterPermission($"eldrunpets.{name}", this);
        }
        ...
        private class NPCController : MonoBehaviour
        {
            ...
            private void TryGetNewPet(BaseNpc npcPet)
            {
                ...
                if (usePermissions && !ins.permission.UserHasPermission(player.UserIDString, $"eldrunpets.{npcPet.ShortPrefabName}"))
                {
