...
{
    [Info("EldrunBetterChat", "Eldrun", "36187")]
    [Description("Allows to manage chat groups, customize colors and add titles.")]
    internal class EldrunBetterChat : CovalencePlugin
    {
        #region Fields

        private static EldrunBetterChat _instance;
        ...
        [Command("chat"), Permission("eldrunbetterchat.admin")]
...
namespace Oxide.Plugins.BetterChatExtensions
{
    internal static class IPlayerExtensions
    {
        ...
        {
            string message = EldrunBetterChat.GetMessage(key, player.Id);
