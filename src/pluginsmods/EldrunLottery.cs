...
{
    [Info("EldrunLottery", "Eldrun", "36187")]
    internal class EldrunLottery : RustPlugin
    {
		...
		void OnServerInitialized() {
            LoadConfig();
			LoadDefaultMessages();
            permission.RegisterPermission("eldrunlottery.canuse", this);
            permission.RegisterPermission("eldrunlottery.canconfig", this);
