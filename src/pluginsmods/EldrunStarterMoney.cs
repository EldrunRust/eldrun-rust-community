...
{
    [Info("EldrunStarterMoney", "Eldrun", "36187")]
    [Description("Customizes the starting balance of players with perms")]
    public class EldrunStarterMoney : CovalencePlugin
    {
        ...
        class Configuration
        {
            ...
            {
                {"eldrunstartermoney.default", 10 },
                {"eldrunstartermoney.vip", 20 },
                {"eldrunstartermoney.god", 30 }
            };
        }
