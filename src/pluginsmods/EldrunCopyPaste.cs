...
{
    [Info("EldrunCopyPaste", "Eldrun", "36187")]
    [Description("Copy and paste buildings to save them or move them")]
    public class EldrunCopyPaste : CovalencePlugin
    {
        ...
        private string _copyPermission = "eldruncopypaste.copy",
            _listPermission = "eldruncopypaste.list",
            _pastePermission = "eldruncopypaste.paste",
            _pastebackPermission = "eldruncopypaste.pasteback",
            _undoPermission = "eldruncopypaste.undo",
        ...
        private class ConfigData
        {
            ...
            public class PasteOptions
            {
                ...
                [DefaultValue((int)EldrunCopyPaste.SkinsMode.AllSkins)]
                public int SkinsMode { get; set; } = (int)EldrunCopyPaste.SkinsMode.AllSkins;
