...
{
    [Info("EldrunMurderers", "Eldrun", "36187")]
    [Description("Murderers Reborn")]
    class EldrunMurderers : RustPlugin
    {
        [PluginReference]
        Plugin Kits;
        ...
        private const string _PermKill = "eldrunmurderers.kill";
        private const string _PermAddLoc = "eldrunmurderers.point";
        private const string _PermSpawn = "eldrunmurderers.spawn";
