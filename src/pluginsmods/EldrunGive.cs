...
namespace Oxide.Plugins
{
    ...
    [Info("EldrunGive", "Eldrun", "36187")]
    [Description("Allows players with permission to give items or kits")]
    public class EldrunGive : CovalencePlugin
    {
        ...
        private const string PermissionGive = "eldrungive.self";
        private const string PermissionGiveAll = "eldrungive.all";
#if REIGNOFKINGS || RUST
        private const string PermissionGiveArm = "eldrungive.arm";
#endif
        private const string PermissionGiveTo = "eldrungive.to";
        private const string PermissionGiveKit = "eldrungive.kit";
        private const string PermissionGiveKitAll = "eldrungive.kitall";
        private const string PermissionGiveKitTo = "eldrungive.kitto";
        private const string PermissionBypassBlacklist = "eldrungive.bypassblacklist";
