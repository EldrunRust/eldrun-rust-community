...
{
    [Info("EldrunGodmode", "Eldrun", "36187")]
    [Description("Allows players with permission to be invulnerable and god-like")]
    internal class EldrunGodmode : RustPlugin
    {
        #region Fields

        private const string PermAdmin = "eldrungodmode.admin";
        private const string PermInvulnerable = "eldrungodmode.invulnerable";
        private const string PermLootPlayers = "eldrungodmode.lootplayers";
        private const string PermLootProtection = "eldrungodmode.lootprotection";
        private const string PermNoAttacking = "eldrungodmode.noattacking";
        private const string PermToggle = "eldrungodmode.toggle";
        private const string PermUntiring = "eldrungodmode.untiring";
        private const string PermAutoEnable = "eldrungodmode.autoenable";
