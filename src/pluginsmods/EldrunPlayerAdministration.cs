...
{
    [Info("EldrunPlayerAdministration", "Eldrun", "36187")]
    [Description("Allows server admins to moderate users using a GUI from within the game.")]
    public class EldrunPlayerAdministration : CovalencePlugin
    {
...
#pragma warning restore CS0162
        ...
        private bool UpgradeTo156() {
            ...
            Dictionary<string, string> oldPerms = new Dictionary<string, string>() {
                { "eldrunplayeradministration.show", CPermUiShow },
                { "eldrunplayeradministration.kick", CPermKick },
                { "eldrunplayeradministration.ban", CPermBan },
                { "eldrunplayeradministration.kill", CPermKill },
                { "eldrunplayeradministration.perms", CPermPerms },
                { "eldrunplayeradministration.voicemute", CPermMute },
                { "eldrunplayeradministration.chatmute", CPermMute },
                { "eldrunplayeradministration.freeze", CPermFreeze },
                { "eldrunplayeradministration.clearinventory", CPermClearInventory },
                { "eldrunplayeradministration.resetblueprint", CPermResetBP },
                { "eldrunplayeradministration.resetmetabolism", CPermResetMetabolism },
                { "eldrunplayeradministration.recovermetabolism", CPermRecoverMetabolism },
                { "eldrunplayeradministration.hurt", CPermHurt },
                { "eldrunplayeradministration.heal", CPermHeal },
                { "eldrunplayeradministration.teleport", CPermTeleport },
                { "eldrunplayeradministration.spectate", CPermSpectate }
            };
        ...
        private bool UpgradeTo1519() {
            bool result = false;
            Dictionary<string, string> oldPerms = new Dictionary<string, string>() {
                { "eldrunplayeradministration.access.voicemute", CPermMute },
                { "eldrunplayeradministration.access.chatmute", CPermMute }
            };
            LogDebug($"Old Perms: {StringDictToString(ref oldPerms)}");
        ...
        private const string CCloseUiCmd = "eldrunplayeradministration.closeui";
        private const string CSwitchUiCmd = "eldrunplayeradministration.switchui";
        private const string CKickUserCmd = "eldrunplayeradministration.kickuser";
        private const string CBanUserCmd = "eldrunplayeradministration.banuser";
        private const string CMainPageBanByIdCmd = "eldrunplayeradministration.mainpagebanbyid";
        private const string CUnbanUserCmd = "eldrunplayeradministration.unbanuser";
        private const string CPermsCmd = "eldrunplayeradministration.perms";
        private const string CMuteUserCmd = "eldrunplayeradministration.muteuser";
        private const string CUnmuteUserCmd = "eldrunplayeradministration.unmuteuser";
        private const string CFreezeCmd = "eldrunplayeradministration.freeze";
        private const string CUnFreezeCmd = "eldrunplayeradministration.unfreeze";
        private const string CClearUserInventoryCmd = "eldrunplayeradministration.clearuserinventory";
        private const string CResetUserBPCmd = "eldrunplayeradministration.resetuserblueprints";
        private const string CResetUserMetabolismCmd = "eldrunplayeradministration.resetusermetabolism";
        private const string CRecoverUserMetabolismCmd = "eldrunplayeradministration.recoverusermetabolism";
        private const string CHurtUserCmd = "eldrunplayeradministration.hurtuser";
        private const string CKillUserCmd = "eldrunplayeradministration.killuser";
        private const string CHealUserCmd = "eldrunplayeradministration.healuser";
        private const string CTeleportToUserCmd = "eldrunplayeradministration.tptouser";
        private const string CTeleportUserCmd = "eldrunplayeradministration.tpuser";
        private const string CSpectateUserCmd = "eldrunplayeradministration.spectateuser";
        private const string CMainPageBanIdInputTextCmd = "eldrunplayeradministration.mainpagebanidinputtext";
        private const string CUserBtnPageSearchInputTextCmd = "eldrunplayeradministration.userbtnpagesearchinputtext";
        private const string CUserPageReasonInputTextCmd = "eldrunplayeradministration.userpagereasoninputtext";
        private const string CBackpackViewCmd = "eldrunplayeradministration.viewbackpack";
        private const string CInventoryViewCmd = "eldrunplayeradministration.viewinventory";
        private const string CGodmodeCmd = "eldrunplayeradministration.godmode";
        private const string CUnGodmodeCmd = "eldrunplayeradministration.ungodmode";
        ...
        private const string CPermUiShow = "eldrunplayeradministration.access.show";
        private const string CPermKick = "eldrunplayeradministration.access.kick";
        private const string CPermBan = "eldrunplayeradministration.access.ban";
        private const string CPermKill = "eldrunplayeradministration.access.kill";
        private const string CPermPerms = "eldrunplayeradministration.access.perms";
        private const string CPermMute = "eldrunplayeradministration.access.mute";
        private const string CPermFreeze = "eldrunplayeradministration.access.allowfreeze";
        private const string CPermClearInventory = "eldrunplayeradministration.access.clearinventory";
        private const string CPermResetBP = "eldrunplayeradministration.access.resetblueprint";
        private const string CPermResetMetabolism = "eldrunplayeradministration.access.resetmetabolism";
        private const string CPermRecoverMetabolism = "eldrunplayeradministration.access.recovermetabolism";
        private const string CPermHurt = "eldrunplayeradministration.access.hurt";
        private const string CPermHeal = "eldrunplayeradministration.access.heal";
        private const string CPermTeleport = "eldrunplayeradministration.access.teleport";
        private const string CPermSpectate = "eldrunplayeradministration.access.spectate";
        private const string CPermDetailInfo = "eldrunplayeradministration.access.detailedinfo";
        private const string CPermProtectBan = "eldrunplayeradministration.protect.ban";
        private const string CPermProtectHurt = "eldrunplayeradministration.protect.hurt";
        private const string CPermProtectKick = "eldrunplayeradministration.protect.kick";
        private const string CPermProtectKill = "eldrunplayeradministration.protect.kill";
        private const string CPermProtectReset = "eldrunplayeradministration.protect.reset";
