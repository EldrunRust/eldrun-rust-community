...
{
    [Info("EldrunStackSizeController", "Eldrun", "36187")]
    [Description("Allows configuration of most items max stack size.")]
    class EldrunStackSizeController : CovalencePlugin
    {
        [PluginReference]
        ...
        private string GetMessage(string key, string playerId)
        {
            ...
            return $"<color=#ff760d><b>[{nameof(EldrunStackSizeController)}]</b></color> " +
        ...
        private void GenerateVanillaStackSizeFile()
        {
            ...
            Interface.Oxide.DataFileSystem.WriteObject(nameof(EldrunStackSizeController) + "_vanilla-defaults",
                vanillaStackSizes);
        ...
        private void SetVanillaDefaults(int code, string response)
        {
            ...
            Interface.Oxide.DataFileSystem.WriteObject(nameof(EldrunStackSizeController) +
