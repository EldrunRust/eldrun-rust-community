...
namespace Oxide.Plugins
{
    ...
    class EldrunBounty : RustPlugin
    {
        ...
        private void Loaded()
        {
            permission.RegisterPermission("eldrunbounty.use", this);
            permission.RegisterPermission("eldrunbounty.admin", this);
